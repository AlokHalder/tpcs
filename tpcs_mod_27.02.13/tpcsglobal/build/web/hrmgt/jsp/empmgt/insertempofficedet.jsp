...
<html:form  action="storeEmpoffiinfo" styleId="trip">
<div align="center"  style="margin-top: 10px">
    ...
    <table border="1" align="center" width="100%" >
        <thead>
            <tr>
                <th colspan="2"><h3>Store Office Details </h3></th>
...
<tbody>
    <tr>
        ...
        <td>            
            <input type="text" value="<bean:write name="employeeProfFormBean" property="name"/>" readonly="true"/><br/><br/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td><html:text property="dateofjoining" styleId="inputField"/>(dd/mm/yyyy)<br>
