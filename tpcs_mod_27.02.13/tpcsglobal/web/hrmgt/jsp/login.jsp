    ...
    <body>
        <div id="main_container">
            ...
            <div class="header_login">
                <div class="logo"><a href="#"><!--img src="images/logo.gif" alt="" title="" border="0" width="" height="" /--></a></div>
            ...
            <div class="login_form">
                ...
                <html:form action="postlogin" styleClass="niceform">


                    <fieldset>

                        <dl style="margin-left:-20px; padding-right:40px;">
                            <dt><label for="userid">User ID:</label></dt>
                            <dd>
                                <html:text property="userid" size="54"/>
                                <font color="red">
                        ...
                        <dl style="margin-left:-20px; padding-right:40px;">
                            ...
                            <dd>
                                <html:password property="password" size="54" styleId=""/>
                                <font color="red">
                        ...
                        <dl>
                            <dt>
                                <html:submit styleId="submit" value="Login" />
                            </dt>
                            <dd style="margin-top:8px;">
                                &nbsp;
                                <font color="red" style="font-weight: bold"> 
                                    <bean:write name="loginActionForm" property="loginMsg"/>
                                </font>
                            </dd>
                        </dl>
                        <dl>
            ...
            <div class="footer_login">
                ...
                <p>ADMIN PANEL | Powered by The Placement Consultancy Services</p>
